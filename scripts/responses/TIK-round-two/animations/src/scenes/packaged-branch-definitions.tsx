...
export default makeScene2D(function* (view) {
  ...
  view.add(
    <ArrowList ref={list}>
      <Txt>
        <Txt.b fill={colors.red500}>Metaphysics</Txt.b> isn't: what is there,
        and also what is the world stuff?
      </Txt>
      <Txt>
        <Txt.b fill={colors.amber500}>Epistemology</Txt.b> isn't: how do I know,
        and also why are the senses invalid?
      </Txt>
      <Txt>
        <Txt.b fill={colors.lime500}>Ethics</Txt.b> isn't: what should I do
        about it, and what are therefore my duties?
      </Txt>
      <Txt>
        Why is <Txt.b fill={colors.sky500}>politics</Txt.b>: how should
        governments be run?
      </Txt>
    </ArrowList>,
  );
  ...
  yield* all(
    ...list().items.map((item, i) =>
      chain(waitFor(0.2 * i), list().hide(item)),
    ),
  );
});
